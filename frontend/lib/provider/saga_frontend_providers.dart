...
final sagaFrontendViewControllerProvider =
    Provider.autoDispose((ref) => SagaFrontendViewController(ref.read));
...
class SagaFrontendViewController {
  SagaFrontendViewController(this.read);
